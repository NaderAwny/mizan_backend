...
public class OtpCodeTests
{
    ...
    {
        // Act
        var otp = OtpCode.Create("01012345678", "123456", expirySeconds: 120);

        // Assert
        Assert.Equal("01012345678", otp.WhatsAppNumber);
    ...
    public void Verify_ExpiredOtp_ShouldThrowBadRequestException()
    {
        ...
        var otp = OtpCode.Create("01012345678", "123456", expirySeconds: -10);
